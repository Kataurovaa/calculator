	...
	<div class="decision">
		...
		<div>
			...
			<div class="d-field">
				<h1 class="d-word">
				<?php
					exec("C:/Server/data/htdocs/calculator/calc/cmake-build-debug/calc.exe") or die("Err");
					$fd = fopen("calc/cmake-build-debug/out.txt", 'r') or die("не удалось открыть файл");
					while(!feof($fd))
					{
    					$str = fgets($fd);
    					echo $str;
					...
					fclose("calc/cmake-build-debug/out.txt");				
				?>
				</h1>
			</div>
		</div>
